...
angular.module('bootstrapLightbox').provider('Lightbox', function () {
  ...
  this.$get = ['$document', '$modal', '$timeout', 'cfpLoadingBar',
     ...
     * @memberOf bootstrapLightbox.Lightbox
     */
    Lightbox.setImage = function (newIndex, direction) {
      ...
      if(typeof Lightbox.images[newIndex] !== 'object'){ 
          if(typeof direction !== 'undefined'){
            Lightbox.setImage(newIndex + direction, direction);
            return;
          }
      }
    ...
    Lightbox.nextImage = function () {
      Lightbox.setImage((Lightbox.index + 1) % Lightbox.images.length, 1);
    };
